...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Pro Pinball: Timeshock!",
    .project_root_env = "PRO_PINBALL_TIMESHOCK_PROJECT_ROOT",
    .build_dir_env = "PRO_PINBALL_TIMESHOCK_BUILD_DIR",
    .force_setup_env = "PRO_PINBALL_TIMESHOCK_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.39_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Pro_Pinball__Timeshock__Recompiled",
    .prepare_note =
