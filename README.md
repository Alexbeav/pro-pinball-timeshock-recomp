# Pro Pinball: Timeshock! Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SLUS-00639 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Pro_Pinball__Timeshock__Recompiled` (`.exe` on Windows).
